...
= 0.1.3 =
* The business profile can be picked on a fresh install. The list of profiles was only fetched once the provider was fully configured, which required the very profile the list was there to choose.
